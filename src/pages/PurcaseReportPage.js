...
import TablePurcaseReport from '../components/TablePurcaseReport';

const PurcaseReportPage = () => {
  const re = /^[0-9\b]+$/;
  const wholeMonth = [
    'Januari',
    'February',
    ...
    <div className='overflow-x-hidden w-screen'>
      <div className='container flex flex-col mx-auto mt-3 font-thin max-w-6xl'>
        <div className='bg-[#009645] text-white px-2 py-3 w-full text-left rounded-t-md font-normal print:hidden'>
          <FaFileInvoiceDollar className='inline-block align-text-top' />{' '}
          Purcase Report
        </div>
...
export default PurcaseReportPage;
